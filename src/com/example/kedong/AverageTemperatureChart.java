...
public class AverageTemperatureChart extends AbstractDemoChart {
	...
	public AverageTemperatureChart(String tt, String xt, String yt){
		title = tt;
		xTitle = xt;
		yTitle = yt;
	}
  ...
  public GraphicalView execute(Context context) {
    ...
    setChartSettings(renderer, title, xTitle, yTitle, 0.5, 12.5, -10, 40,
...
//        "Average temperature");
    GraphicalView gv = ChartFactory.getLineChartView(context, dataset, renderer);
    return gv;
  }
